...
class Categorical(Distribution):
	...
	# We added this to be used in modified factor graph
	def update_probs(self, probs):
		"""Update the model parameters given a new set of probabilities.

		This method uses a new set of probabilities to update the distribution
		parameters. Hyperparameters for the update are passed in at initialization
		time.


		Parameters
		----------
		probs: list, numpy.ndarray, torch.Tensor, shape=(self.d, self.n_keys)
